// ============================================================
//  💝 LOVORA — SHAXSIY SOZLAMALAR
//  Faqat shu faylni to'ldiring. Boshqa fayllarga tegmang.
// ============================================================
window.LOVORA_CONFIG = {

  // ---- Ismlar va sana ----
  me: "Saydullo",          // Sizning ismingiz
  partner: "Osiyo",        // Uning ismi
  startDate: "2026-08-02",  // Munosabat boshlangan sana (YYYY-MM-DD)

  // ---- Uning sevimli rangi (oq-qizil, och pushti) ----
  themeColor: "#ff8fb3",
